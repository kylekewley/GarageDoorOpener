...
// Source file: /home/kylekewley/Programming/C++/GarageServer/ProtocolBuffers/GarageStatus.proto
...
public final class GarageStatus extends Message {
  ...
  public static final class DoorStatus extends Message {
    ...
    public DoorStatus(Integer uniqueId, Integer garageId, Integer timestamp, Boolean isClosed) {
    ...
    private DoorStatus(Builder builder) {
      this(builder.uniqueId, builder.garageId, builder.timestamp, builder.isClosed);
      setBuilder(builder);
    }
    ...
    public boolean equals(Object other) {
      ...
      return equals(uniqueId, o.uniqueId)
