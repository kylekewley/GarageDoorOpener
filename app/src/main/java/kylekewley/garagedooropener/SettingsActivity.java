...
public class SettingsActivity extends PreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        try {
            Class.forName(fragmentName, false, this.getClass().getClassLoader());
    ...
    /**
     * This fragment shows host data preferences only. It is used when the
     * activity is showing a two-pane settings UI.
     */
    public static class HostDataPreferenceFragment extends PreferenceFragment {
        @Override
